...
package fretx.version3.ShareMe;
...
public class ShareFragment extends Fragment {
    ...
    private static final ArrayList<Pair<Integer, String>> IMAGE_IDS =
            new ArrayList<Pair<Integer, String>>() {{
                add(new Pair<>(R.drawable.fretxone, "http://www.fretx.rocks/"));
                add(new Pair<>(R.drawable.fretxtwo, "https://www.facebook.com/fretxRocks/"));
                add(new Pair<>(R.drawable.fretxthree, "https://www.facebook.com/fretxRocks/"));
            }};
