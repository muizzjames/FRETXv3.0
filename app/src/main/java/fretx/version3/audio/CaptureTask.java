...
import fretx.version3.PTuneFragment;
...
public class CaptureTask extends AsyncTask<Float, Float, Void> {
	...
	private PTuneFragment mainActivity;
	
	public CaptureTask(PTuneFragment context) {
	...
	@Override
	protected void onProgressUpdate(Float... freq) {
